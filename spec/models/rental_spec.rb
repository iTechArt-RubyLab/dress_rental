...
RSpec.describe Rental, type: :model do
  ...
  let(:rental) { create(:rental, user: user, product: product) }
  ...
  describe "validations" do
    ...
    it "validates product availability" do
      rental.save
      rental2 = build(:rental, user: user, product: product, start_date: rental.start_date + 1.day, end_date: rental.end_date - 1.day)
  ...
  describe "scopes" do
    describe ".rated_by_users_rentals" do
      ...
      let!(:rental4) { create(:rental, product: product, user_rating: 3)}
